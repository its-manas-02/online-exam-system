    ...
    <div className="min-h-screen p-6 bg-gray-100">      
      ...
      <div className="max-w-4xl p-6 mx-auto bg-white shadow-lg rounded-xl">        
        <form onSubmit={handelsubmit}>
          {/* Title */}
          <h2 className="mb-6 text-2xl font-bold text-center text-gray-800">Add Quiz</h2>
          ...
          <div className="space-y-6 max-h-[65vh] overflow-y-auto pr-2">
            {questions.map((_, i) => (
              <div key={i} className="p-4 transition border rounded-lg bg-gray-50 hover:shadow-md">
                <h3 className="mb-3 text-lg font-semibold text-blue-600">Question {i + 1}</h3>
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  {[1, 2, 3, 4].map((opt) => (
                    <div key={opt}>
                      <label className="block mb-1 text-sm text-gray-600">Option {opt}</label>
                      <input
                        type="text"
                        name={`option-${i}-${opt}`}
                        onChange={handleChange}
            ...
            <div className="w-[90%] max-w-3xl max-h-[80vh] overflow-y-auto p-6 bg-white rounded-lg">
              ...
              <div className="flex justify-end gap-3 mt-4">
                <button
                  ...
                  className="px-4 py-2 bg-gray-400 rounded">Close
                </button>
